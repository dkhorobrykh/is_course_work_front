...
import BookFlightForm from "../forms/BookFlightForm";

const BookFlightButton = ({flightId, user}) => {
    ...
    return (
        <div>
            <Box sx={{textAlign: 'center'}}>
                ...
                {openCreateForm &&
                    <BookFlightForm onSave={handleSave} onClose={handleCloseCreateForm} setError={setError}
                                        setSuccess={setSuccess} flightId={flightId} user={user}/>
                }
            </Box>
        </div>
    );
